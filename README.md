...
I'm a curious, people-focused engineer who turns bold ideas into **fast, reliable web and mobile apps**. I care about software that works under pressure, where performance, security, and accessibility actually matter.

**15+ years in tech** · **8+ years shipping full-stack products** from scratch.

I started with systems administration in The Gambia, studied software applications, taught in schools, and grew into full-stack development after relocating to Berlin. Before development, I managed networks, servers, and user support for a 50-person office.

---

### What I do

- Build and modernize **web and mobile** applications with **JavaScript, TypeScript, React, React Native, Next.js, and Node.js**
- Design **scalable frontends** with **Vite, Redux, Zustand, TanStack Query, and Tailwind CSS**
- Ship **REST APIs**, optimize **MongoDB** at scale, and tune systems for **sub-100ms** query performance
- Run **AWS** infrastructure with **Docker, Kubernetes, Redis, and CI/CD**, cost-aware and built for reliability
- Improve **Core Web Vitals**, **SEO**, and **accessibility** on high-traffic platforms
- Mentor developers, write clear documentation, and keep codebases maintainable for the next team

---

### Types of work

Across **healthcare**, **civic tech**, **proptech**, **edtech**, and **startups**, I've worked on:

- Legacy platform modernization into responsive, secure **React + TypeScript** apps
- **Mobile-first** products with offline support and cross-device sync
- High-traffic advocacy and campaign platforms serving **100k+ monthly users**
- **GDPR-aligned** access, encryption, role-based permissions, and audit-ready workflows
- Cloud cost optimization while maintaining **99.9% uptime**
- **React Native** rebuilds with stronger engagement, faster loads, and store-ready quality

Most of my production work is private. You can see more on my [portfolio](https://ansumana-darboe.netlify.app).

---

### Let's connect

- 🌐 Portfolio → [ansumana-darboe.netlify.app](https://ansumana-darboe.netlify.app)
- 💼 LinkedIn → [linkedin.com/in/ansumana-darboe](https://www.linkedin.com/in/ansumana-darboe/)
- 📫 Email → [thisisansumana@gmail.com](mailto:thisisansumana@gmail.com)
...
<div align="center">
    ...
    <code><a href="https://reactnative.dev/" target="_blank"><img alt="React Native" src="https://img.icons8.com/color/48/react-native.png" title="React Native" width="40"></a></code>
    ...
    <code><a href="https://vitejs.dev/" target="_blank"><img alt="Vite" src="https://vitejs.dev/logo.svg" title="Vite" width="40"></a></code>
    ...
    <code><a href="https://tailwindcss.com/" target="_blank"><img alt="Tailwind CSS" src="https://www.vectorlogo.zone/logos/tailwindcss/tailwindcss-icon.svg" title="Tailwind CSS" width="40"></a></code>
    ...
    <code><a href="https://redis.io/" target="_blank"><img alt="Redis" src="https://www.vectorlogo.zone/logos/redis/redis-icon.svg" title="Redis" width="40"></a></code>
    ...
    <code><a href="https://restfulapi.net/" target="_blank"><img alt="REST" src="https://user-images.githubusercontent.com/25181517/192107858-fe19f043-c502-4009-8c47-476fc89718ad.png" title="REST APIs" width="40"></a></code>
    ...
    <code><a href="https://code.visualstudio.com/" target="_blank"><img alt="VS Code" src="https://user-images.githubusercontent.com/25181517/192108891-d86b6220-e232-423a-bf5f-90903e6887c3.png" title="VS Code" width="40"></a></code>
